...
HEADERS += sensors/torcphsensor.h
HEADERS += sensors/torcnetworkswitchsensor.h
HEADERS += sensors/torcnetworkpwmsensor.h
HEADERS += sensors/torcnetworktemperaturesensor.h
HEADERS += sensors/torcnetworkphsensor.h
HEADERS += sensors/torcnetworkbuttonsensor.h
...
SOURCES += sensors/torcphsensor.cpp
...
SOURCES += sensors/torcnetworktemperaturesensor.cpp
SOURCES += sensors/torcnetworkphsensor.cpp
SOURCES += sensors/torcnetworkbuttonsensor.cpp
